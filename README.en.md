...
[Install 2.1.2](#install) · [Ask better questions](#ask-better-questions) · [Project website](https://muyuanguo.github.io/badminton-skills-coach/en/) · [Report answer feedback](https://github.com/MuyuanGuo/badminton-skills-coach/issues/new?template=skill-feedback.yml) · [中文 README](README.md)

You are viewing the `develop` branch; the current development version is **2.1.3-dev.1** and its release status is **unreleased**. Stable installs remain on `main` and [v2.1.2](https://github.com/MuyuanGuo/badminton-skills-coach/releases/tag/v2.1.2). This independent project is not authored, operated, endorsed, or approved by Liu Hui or the source publishers.
...
## Current development build (2.1.3-dev.1)

This branch collects unreleased data, runtime, and engineering changes on top of stable 2.1.2. It describes the development tree, not an already available stable package.
...
- 783 primary sources lead. 175 bounded supplemental sources may fill a concept, condition, drill, or equipment gap only through matched timestamp windows.
