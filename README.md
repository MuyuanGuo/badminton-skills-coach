...
这是 **1.4.0 稳定版**。GitHub `main` 分支和 [`v1.4.0` Release](https://github.com/MuyuanGuo/badminton-skills-coach/releases/tag/v1.4.0) 提供当前正式版本；`develop` 用于后续增量维护。本项目不是刘辉本人，也不代表其个人观点或背书。
