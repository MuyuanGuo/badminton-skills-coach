...
10. 生成主题索引，形成后场、步法、发力、双打、发接发等技术地图。
11. 运行验证脚本和检索评估。
12. 将稳定的知识、混合检索、回答合同和主题索引封装为 Codex Skill。
...
10. Build a topic index covering rear-court technique, footwork, power generation, doubles, serve receive, and related themes.
11. Run validation and retrieval evaluation.
12. Package stable knowledge, hybrid retrieval, the answer contract, and the topic index as a Codex Skill.
...
- Use the topic index to orient the question in the technical map
