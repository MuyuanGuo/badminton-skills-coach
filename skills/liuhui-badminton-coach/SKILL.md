...
- Treat `压球` and similar downward-pressure wording as context-dependent: distinguish rear-court smash pressure from forecourt or midcourt interception, and state any returned ambiguity before coaching instead of defaulting to smash.
