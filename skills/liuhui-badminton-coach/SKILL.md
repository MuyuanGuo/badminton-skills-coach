...
- Preserve active/passive, singles/doubles, forehand/backhand, level, and court-position distinctions. Treat `挑球` as a distinct lift action rather than generic backhand, forehand, clear, drive, or net-play evidence; when the user asks for a lift, require direct lift support instead of relying on an incidental transcript mention such as an opponent being forced to lift.
