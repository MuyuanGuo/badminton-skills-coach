...
"""
    ...
    def test_skill_and_agent_status_counts_follow_knowledge(self):
        ...
        skill = """---
description: Archive from the full 406-video processed knowledge base, including 350 ready teaching videos from verified sources.
---
...
"""
        ...
        self.assertIn(
            "full 4-video processed multi-source knowledge base", updated_skill
        )
        self.assertIn(
            "including 2 ready teaching videos from verified sources.",
            updated_skill,
        )
        self.assertIn(
