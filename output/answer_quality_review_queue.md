...
知识库版本：`2026-08-11T09:19:47.612085+00:00`
候选问题：`57`
可进入自动回归：`57`
仍待审核：`0`

问题类型：`diagnosis` 9 条、`evidence_boundary` 8 条、`tactics` 8 条、`technical_action` 29 条、`training_plan` 3 条
...
- 类型：`technical_action`
- 预期模式：`balanced`
- 来源：`maintainer_ambiguity_audit`
- 当前状态：`maintainer_reviewed`
- 自动回归资格：已有

### 已有视频标签

- 主证据候选: [各种双打都需要，苍蝇拍压不住被动的球](https://www.douyin.com/video/7077740726926298402) (`7077740726926298402`)
- 主证据候选: [压迫位封网 祝大家新年快乐！大年初二也不要忘记研究羽毛球啊！](https://www.douyin.com/video/7607852875611759802) (`7607852875611759802`)
...
```json
{
  "maintainer_decision": "approved",
  "maintainer_reviewer": "Codex evidence review",
  "maintainer_reviewed_at": "2026-07-19",
  "primary_video_ids": [
    "7077740726926298402",
    "7607852875611759802"
  ],
  ...
  "required_text_points": [
    {
      "description": "封网来球已从身前进入正身位时，不应继续使用只适合身前主动球的苍蝇拍握法，应切换传统握拍并用前臂、手腕和手指旋转发力。",
      "acceptable_terms": [
        "正身位",
        "传统握拍",
        "旋转发力"
    ...
    {
      "description": "对手来球很冲、已经失去前点击球时，可以后撤大臂改变有效下压点，避免按原拍臂关系把球向上或向远处打。",
      "acceptable_terms": [
        "来球很冲",
        "大臂向后撤",
        "改变压球点"
  ...
  "required_boundary_points": [
    {
      "description": "这里的压球是双打中前场或封网处理，不得自动解释成后场重杀、跳杀或遁地炮。",
      "acceptable_terms": [
        "中前场",
        "封网",
        "不是后场重杀"
  ...
  "notes": "把中前场封网下压与后场杀球分开；保留两条直接讲封网握拍切换和受压击球点调整的来源，把纯重杀、跳杀来源列为硬负例。"
}
```
...
- 类型：`technical_action`
- 预期模式：`balanced`
- 来源：`maintainer_court_scope_audit`
- 当前状态：`maintainer_reviewed`
- 自动回归资格：已有
...
```json
{
  ...
  "required_text_points": [
    {
      "description": "网前封球进入正身位后要从只适合身前主动球的苍蝇拍握法切换到传统握拍，并用前臂、手腕和手指旋转发力。",
      "acceptable_terms": [
        "正身位",
        "传统握拍",
        "旋转发力"
    ...
    {
      "description": "来球很冲且失去前点时，可后撤大臂改变有效下压点，避免原拍臂关系把球送高或送远。",
      "acceptable_terms": [
        "来球很冲",
        "大臂向后撤",
        "改变压球点"
  ...
  "required_boundary_points": [
    {
      "description": "用户已明确网前，因此没有前场或中前场范围证据的通用下压、压抽及后场杀球来源不能作为动作证据。",
      "acceptable_terms": [
        "明确网前",
        "场区证据",
        "不能用后场杀球"
  ...
  "forbidden_claims": [
    "后场杀球辅助练习可以直接证明网前下压动作",
    "只要讲下压就不需要区分场区",
    "双打压抽默认发生在网前"
  ],
  "notes": "明确网前场区时只保留直接支持前场或中前场封网下压的来源；后场杀球训练和没有场区证据的双打压抽不得证明网前动作。"
}
```
...
- 类型：`technical_action`
- 预期模式：`balanced`
- 来源：`maintainer_missing_action_audit`
- 当前状态：`maintainer_reviewed`
- 自动回归资格：已有

### 已有视频标签

- 主证据候选: [反手挑球 嗓子哑了，轻声细语发不出声，只能使点劲儿说话](https://www.douyin.com/video/7523163965838003514) (`7523163965838003514`)
- 必看候选: [反手基础速成版 一定注意看肘的动作和架拍位置，不要因为怕撅腕就不用手腕，那是两个意思](https://www.douyin.com/video/7511934047901846841) (`7511934047901846841`)
- 必看候选: [安排，正反手一起](https://www.douyin.com/video/7151961376448138531) (`7151961376448138531`)
...
```json
{
  ...
  "required_text_points": [
    {
      "description": "反手挑球是来球落到下手位置后的向上处理，通常用于被动把球挑高、挑深，而不是上手位的反手高远或杀球。",
      "acceptable_terms": [
        "下手技术",
        "被动",
        "向上处理"
    ...
    {
      "description": "握拍拇指不要僵顶在宽面，应微调到斜面，让手腕角度能帮助拍头向上；随后由大臂带动小臂外旋完成向上发力。",
      "acceptable_terms": [
        "拇指斜面",
        "拍头向上",
        "小臂外旋"
    ...
    {
      "description": "动作方向是手腕从下往上配合小臂转动；手腕横着动对应其他反手处理，不能代替挑球的向上动作。",
      "acceptable_terms": [
        "从下往上",
        "小臂转动",
        "不要横着动"
    ...
    {
      "description": "掌握基础挑球后再练假挑真放变化：正反手都要区分向上挑球与切削放网的拍面处理，并保持手腕稳定。",
      "acceptable_terms": [
        "假挑真放",
        "切削",
        "锁住手腕"
  ...
  "required_boundary_points": [
    {
      "description": "反手挑球必须与反手高远、反手杀球和反手抽挡分开；只有反手标签而没有挑球证据的来源不能证明该动作。",
      "acceptable_terms": [
        "反手挑球",
        "不同动作",
        "直接挑球证据"
  ...
  "notes": "把反手挑球建成独立动作范围；只保留直接讲反手挑球的专项或明确分段来源，排除同为反手但实际讲杀球、高远、抽挡，以及标题提到挑球但证据不支持动作的视频。"
}
```
...
- 主证据候选: [正反手过渡 先掌握核心技术，剩下的靠自己也是不错的方法](https://www.douyin.com/video/7515625891511995706) (`7515625891511995706`)
- 必看候选: [日常纠错反手过渡 总结，大臂不要上下晃，尤其是够的太高完了击球的时候还掉下来，保持住大臂的高度](https://www.douyin.com/video/7393550140465777960) (`7393550140465777960`)
- 必看候选: [过渡击球点 简单来说就是放在外侧击球](https://www.douyin.com/video/7563513758061114875) (`7563513758061114875`)
- 必看候选: [反手动作不唯一，但是这种好上手，击球点在转过去的身前外侧](https://www.douyin.com/video/7060717442825309480) (`7060717442825309480`)
- 必看候选: [这个是一个思路，帮助没有过渡基础的朋友找到感觉，不能说两个技术感觉一模一样，但是手感非常的接近](https://www.douyin.com/video/7344186576013905187) (`7344186576013905187`)
- 必看候选: [反手基础速成版 一定注意看肘的动作和架拍位置，不要因为怕撅腕就不用手腕，那是两个意思](https://www.douyin.com/video/7511934047901846841) (`7511934047901846841`)
...
```json
{
  ...
  "required_text_points": [
    {
      "description": "先用触球后的飞行方向检查拍面：球向外飞说明拍面不适合过渡；调到球向内弹后保留该拍面，再向斜前方挥拍。反手侧让球拍成为小臂延伸，手背与拍面接近同一平面。",
      "acceptable_terms": [
        "球向内弹",
        "保留拍面",
        "手背和拍面"
    ...
    {
      "description": "步法先创造纵向距离，再横向找球，使来球落在身体外侧；不要先迈右脚向前追，贴球太近会失去动作末端的包裹空间。",
      "acceptable_terms": [
        "纵向距离",
        "外侧击球",
        "离球远一点"
    ...
    {
      "description": "反手过渡抬手到接近肩平即可，球拍向右后方横带；顶肘后保持大臂高度，不要超过肩也不要在击球中掉下来，再在框架内完成小臂外旋。",
      "acceptable_terms": [
        "抬手抬平",
        "大臂不要掉",
        "小臂外旋"
    ...
    {
      "description": "来球到身后时要立起球拍避免回球过高，并按击球位置微调拇指和握拍，使拍面能朝内包裹而不是僵直朝外。",
      "acceptable_terms": [
        "立起球拍",
        "握拍微调",
        "拍面朝内"
    ...
    {
      "description": "找不到过渡手感时，可先练带包切的勾球，再逐渐抬高击球点和框架到后场；两种技术手感接近但并不等同。",
      "acceptable_terms": [
        "包切勾球",
        "逐渐抬高",
        "不完全一样"
    ...
    {
      "description": "综合反手动作中，过渡球以保持手腕、主要让小臂转动的方向完成；它和高远、劈吊、挑球是同一反手体系中的不同分支。",
      "acceptable_terms": [
        "保持手腕",
        "小臂转动",
        "不同分支"
  ...
  "required_boundary_points": [
    {
      "description": "反手过渡球不能由泛反手、高远、杀球或挑球来源直接证明；必须使用明确的过渡动作或审核分段证据。",
      "acceptable_terms": [
        "反手过渡球",
        "不同动作",
        "直接过渡证据"
  ...
  "notes": "把反手过渡球建成独立动作范围；保留动作核心、击球点、纠错、握拍和训练方法的直接来源，排除同为反手但实际讲高远、杀球或挑球的内容。"
}
```
...
- 主证据候选: [训练都是实录，按理说时间得控制在两分钟之内，不然就没人看了](https://www.douyin.com/video/7215787369381858599) (`7215787369381858599`)
- 必看候选: [其实接被动球，最稳的就是两条腿尽量在中间留一条腿](https://www.douyin.com/video/7117821949165718824) (`7117821949165718824`)
- 必看候选: [算是和上一个作品做呼应，巧妙的用肘带动手腕，是成为高手的必经之路](https://www.douyin.com/video/7289635377009151247) (`7289635377009151247`)
- 必看候选: [9243 纠错小课堂2 之准备框架](https://www.douyin.com/video/7141200093922790688) (`7141200093922790688`)
- 必看候选: [低姿准备 有低姿态准备，也有高姿态的准备，可以不用，不能不会，因为除了累其他的都是优点](https://www.douyin.com/video/7422121561559272739) (`7422121561559272739`)
- 必看候选: [高手进阶 正反手都是一样的道理，王柏钦是个非常有天赋的人，很少见](https://www.douyin.com/video/7647839024535507897) (`7647839024535507897`)

### 机器补充候选

- 机器候选: [打羽毛球最爽的就是杀球和接杀](https://www.douyin.com/video/7090377448017235234) (`7090377448017235234`)
...
```json
{
  "maintainer_decision": "approved",
  "maintainer_reviewer": "Codex evidence review",
  "maintainer_reviewed_at": "2026-07-20",
  "primary_video_ids": [
    "7215787369381858599"
  ],
  "required_video_ids": [
  ...
  "required_text_points": [
    {
      "description": "高速接杀时不要临时做来不及的正反手握拍转换；可用反手握拍覆盖追身和两侧来球，让手臂带动手腕完成短促、快速的出拍。",
      "acceptable_terms": [
        "不要转换",
        "反手握拍",
        "短促快速"
    ...
    {
      "description": "反手区接杀不是每次都先迈右脚；来球不远时尽量保留一条腿在身体中间以便直接回位，只有杀球距离特别远时才扩大跨步。",
      "acceptable_terms": [
        "不要轻易迈右脚",
        "保留一条腿",
        "特别远"
    ...
    {
      "description": "接杀动作时间短、幅度不能大，也不能只甩手腕；要用肘和手臂带动手腕，同时给握拍与手腕转动保留空间。",
      "acceptable_terms": [
        "动作不能大",
        "肘带动手腕",
        "不能只动手腕"
    ...
    {
      "description": "准备框架中肘和大臂要预先抬起，腋下留出空间；来球时通过翻拍快速形成接杀框架，而不是再做一套大幅架拍。",
      "acceptable_terms": [
        "肘和大臂抬起",
        "腋下空间",
        "翻拍"
    ...
    {
      "description": "接杀准备要降低重心并保持适度前倾，使身体已经靠近前场来球需要的位置，避免球到后再额外向前探。",
      "acceptable_terms": [
        "降低重心",
        "身体前倾",
        "不要再往前探"
    ...
    {
      "description": "进阶反手接杀可借来球力量快速出手，但受压时不能把手腕僵硬顶出去；需要在具体击球空间内完成短促传力。",
      "acceptable_terms": [
        "借力",
        "快速出手",
        "手腕不能僵顶"
  ...
  "required_boundary_points": [
    {
      "description": "反手挡杀/接杀必须与本方反手杀球、反手挑球和泛防守战术分开；只有反手或防守标签、或只描述对手和队友接杀的来源，不能证明用户自己的挡杀动作。",
      "acceptable_terms": [
        "反手挡杀",
        "不同动作",
        "直接接杀证据"
  ...
  "notes": "把挡杀/接杀建成独立动作范围；保留反手握拍、短促发力、反手区步法、准备框架和低姿态的直接来源，排除同为反手但实际讲跳杀、高远或过渡，以及只讲进攻端杀吊的内容。"
}
```
...
- 主证据候选: [动作，击球点，握拍，步法，对于反手滑板这种难度高的动作都不是最重要的，必会的决心才是最重要的](https://www.douyin.com/video/7214304020775652620) (`7214304020775652620`)
...
```json
{
  ...
  "required_text_points": [
    {
      "description": "当前知识库可可靠确认的专项来源是反手滑板视觉示范，复核摘要覆盖动作、击球点、握拍和步法；这些空间关系应以视频观察为主。",
      "acceptable_terms": [
        "反手滑板",
        "击球点",
        "握拍",
    ...
    {
      "description": "该视频没有可用口播转写，现有视觉摘要不足以支持更细的拍面角度、触球方向或发力次序；回答必须保留这一证据限制。",
      "acceptable_terms": [
        "视觉复核",
        "没有口播转写",
        "不能确定细节"
  ...
  "required_boundary_points": [
    {
      "description": "反手滑板不能由泛反手、普通吊球、劈吊或反手跳杀来源直接证明；杀球中说“有滑板介入”也不能替代反手滑板专项证据。",
      "acceptable_terms": [
        "反手滑板",
        "具体变体",
        "直接滑板证据"
  ...
  "notes": "把用户常说的“滑板”识别为吊球下的具体切削变体；只保留经过视觉复核的反手滑板专项，排除同为反手的跳杀、普通吊球/劈吊，以及杀球来源中顺带提到滑板介入的片段。"
}
```
...
- 类型：`technical_action`
- 预期模式：`balanced`
- 来源：`maintainer_drop_variant_audit`
- 当前状态：`maintainer_reviewed`
- 自动回归资格：已有

### 已有视频标签

- 主证据候选: [这样削球是最稳定的劈吊](https://www.douyin.com/video/7306709804234444072) (`7306709804234444072`)
- 必看候选: [音乐归途有风，让我唤各位走弯路的朋友回来😂](https://www.douyin.com/video/7174229898238676228) (`7174229898238676228`)
- 必看候选: [这属于为了下一拍更好衔接的步法，也是使用率最高的](https://www.douyin.com/video/7229889111706848544) (`7229889111706848544`)
- 必看候选: [反手基础速成版 一定注意看肘的动作和架拍位置，不要因为怕撅腕就不用手腕，那是两个意思](https://www.douyin.com/video/7511934047901846841) (`7511934047901846841`)
- 必看候选: [重劈，注意结束点可不能靠前了，属于本人绝活😉](https://www.douyin.com/video/7118192644957818127) (`7118192644957818127`)
- 必看候选: [并不是说一定要一步回位。而是体现向左回动，左脚的重要性](https://www.douyin.com/video/7059589039694957864) (`7059589039694957864`)

### 机器补充候选

- 机器候选: [1038 劈吊进阶 压腕加速，锁腕控力，转着击加大包切效果可重劈吊](https://www.douyin.com/video/7665812689277115897) (`7665812689277115897`)
...
```json
{
  ...
  "required_text_points": [
    {
      "description": "劈吊要在正常上手击球基础上，通过侧身转正过程中的触球与向前随挥形成包裹效果；击球点还应尽量拿高，不能只用拍面横向刮球。",
      "acceptable_terms": [
        "侧身转正",
        "包裹效果",
        "击球点高"
    ...
    {
      "description": "劈吊与滑板的隐蔽性都应和对应线路的高远球技术点形成一致性；具体切削方向不同，但不能先暴露成一套完全不同的准备动作。",
      "acceptable_terms": [
        "高远球",
        "隐蔽性",
        "技术点一致"
    ...
    {
      "description": "正手位较靠后时可用半侧身处理斜线劈吊，不要过度侧身或盲目换脚；这样既保留斜线出球空间，也减少下一拍回位距离。",
      "acceptable_terms": [
        "半侧身",
        "不要换脚",
        "回位"
    ...
    {
      "description": "反手劈吊是另一条动作分支：审核分段明确要求拍面约向外调整并配合小臂外旋、在较高点完成，不能直接照搬正手劈吊细节。",
      "acceptable_terms": [
        "反手劈吊",
        "拍面向外",
        "小臂外旋"
  ...
  "required_boundary_points": [
    {
      "description": "普通吊球、劈吊和滑板是同属吊球家族但切削方式不同的变体；只有普通吊球、反手滑板或泛杀吊战术证据，不能证明劈吊动作细节。",
      "acceptable_terms": [
        "普通吊球",
        "劈吊",
        "滑板",
  ...
  "notes": "把劈吊从普通吊球和反向切削的滑板中拆出；保留直接讲包裹、正手位步法、反手劈吊分段和上手一致性的来源，排除普通吊球、反手滑板、泛杀吊战术及比赛中的偶然动作提及。"
}
```
...
- 类型：`technical_action`
- 预期模式：`balanced`
- 来源：`maintainer_smash_variant_audit`
- 当前状态：`maintainer_reviewed`
- 自动回归资格：已有

### 已有视频标签

- 主证据候选: [大家不要断章取义，手的大小，手胶的粗细，协调性，爆发力人人都不一样，没有谁和谁的动作是完全一样的，抓住核心点，这个都一样](https://www.douyin.com/video/7272944156618542336) (`7272944156618542336`)
- 必看候选: [花两分多钟把视频看完，让朋友们不在徘徊](https://www.douyin.com/video/7125615679402724623) (`7125615679402724623`)
- 必看候选: [软压还包括点杀，远网吊球等等](https://www.douyin.com/video/7093706918492917033) (`7093706918492917033`)
...
```json
{
  ...
  "required_text_points": [
    {
      "description": "点杀不以重杀的绝对力量为目标；来源直接指出点杀力量相对小，重点是短促、可控的快速下压。",
      "acceptable_terms": [
        "不以重杀",
        "绝对力量",
        "力量相对小"
    ...
    {
      "description": "握拍时食指和拇指负责牵住球拍，掌心留空，后三指向下抓握并配合小臂；不能把拇指僵卡在拍柄上。",
      "acceptable_terms": [
        "食指和拇指",
        "掌心留空",
        "后三指"
    ...
    {
      "description": "点杀属于手指主导的小边甩，身体主要维持稳定；这与重杀依靠身体主导的大边甩不同，也不需要刻意制造内旋。",
      "acceptable_terms": [
        "手指主导",
        "小边甩",
        "身体主要维持"
    ...
    {
      "description": "位置不好时不宜勉强全力杀；轻杀或软压可以保留下压，让球速稍慢，从而减少脚下脱节并便于下一拍跟进。",
      "acceptable_terms": [
        "位置不好",
        "软压",
        "下一拍跟进"
  ...
  "required_boundary_points": [
    {
      "description": "普通杀球、重杀和跳杀不能替代点杀专项动作证据；高点杀球、点杀一样的效果和把点杀得很尖只是字面重叠，也不能证明点杀技术。",
      "acceptable_terms": [
        "普通杀球",
        "高点杀球",
        "字面重叠"
  ...
  "notes": "把点杀从普通杀球、重杀和跳杀中拆出；保留两条直接动作来源和一条软压跟进战术来源，排除高点杀球、点杀式效果等连续字面假命中。"
}
```
...
- 主证据候选: [兄弟们，学不会起跳的，咱们先来个引导版吧，自己打个几次就会正式的了](https://www.douyin.com/video/7161980324409363712) (`7161980324409363712`)
- 必看候选: [注意击球点要在起跳的高点击，而不是向上的过程中，45度起跳是更容易的起跳杀球，视频中的侧身跳杀对身体要求更多，腿有伤，大家忽略高度😂](https://www.douyin.com/video/7055491154288102667) (`7055491154288102667`)
- 必看候选: [这次时间有限，击球点还得在往前放一点，别扭的地方可以迎刃而解](https://www.douyin.com/video/7138604160051612969) (`7138604160051612969`)
- 必看候选: [起跳进阶 有的时候努力得不到回报，有可能是方向选择错了](https://www.douyin.com/video/7634016952800880570) (`7634016952800880570`)
- 必看候选: [进阶起跳](https://www.douyin.com/video/7606560547489149691) (`7606560547489149691`)
- 必看候选: [女生跳杀 跳杀猛女](https://www.douyin.com/video/7561558424342056250) (`7561558424342056250`)
- 必看候选: [重杀，遁地炮，跳杀连贯 很多年不见了，很怀念带她们训练的日子](https://www.douyin.com/video/7506362888166083897) (`7506362888166083897`)
...
```json
{
  ...
  "required_text_points": [
    {
      "description": "入门跳杀先保证在起跳后、落地前完成挥拍；关键是挥拍速度，因此可先缩小挥拍和转体幅度，建立简配版跳杀，而不是先追求高度。",
      "acceptable_terms": [
        "落地前完成挥拍",
        "挥拍速度",
        "简配版跳杀"
    ...
    {
      "description": "跳杀不是原地直上直下，而是转跳；可先练转跳，再用半侧身起跳并在空中转体向前完成击球。",
      "acceptable_terms": [
        "不是原地直上直下",
        "转跳",
        "空中转体向前"
    ...
    {
      "description": "起跳后要及时完成架拍和转体，在最高点附近把拍准备好，并在人开始下落时完成击球；屈腿和后脚动作应由身体发力与平衡自然形成，不要刻意摆造型。",
      "acceptable_terms": [
        "及时完成架拍",
        "开始下落时",
        "不要刻意"
    ...
    {
      "description": "起跳效率强调少蹲、快蹲、快起，不要提前站死或深蹲后全力慢跳；缩短起跳过程才能在空中保留更多动作余量。",
      "acceptable_terms": [
        "少蹲",
        "快蹲",
        "快起"
    ...
    {
      "description": "进阶双脚跳杀不要把全部力量耗在起跳上；摆臂借力、调整击球点和大臂位置，并让空中身体保持可转动姿态，才能把腰腹力量传到拍头。",
      "acceptable_terms": [
        "不要把全部力量耗在起跳",
        "摆臂借力",
        "腰腹力量"
    ...
    {
      "description": "女性专业选手专项来源强调双手摆动帮助起跳、快速抬拍争取空中组织框架的时间，并避免深蹲；这是有明确人群和能力条件的纠错。",
      "acceptable_terms": [
        "女性专业选手",
        "双手摆动",
        "快速抬拍"
    ...
    {
      "description": "连续进攻时不必每一拍都全力跳杀；可先用较小侧身、较快的跳杀保持连贯，在出现终结机会时再增加全力重杀。",
      "acceptable_terms": [
        "不必每一拍都全力",
        "保持连贯",
        "终结机会"
  ...
  "required_boundary_points": [
    {
      "description": "泛杀球、点杀、重杀、遁地炮、反手跳杀和只讲普通起跳的来源不能替代正手跳杀专项；进阶、女性专业选手和连续进攻来源必须保留适用条件。",
      "acceptable_terms": [
        "反手跳杀",
        "不能替代正手跳杀",
        "适用条件"
  ...
  "notes": "把正手跳杀从泛杀球、重杀、点杀、遁地炮、反手跳杀和普通起跳中拆出；按入门简配、转跳与架拍、起跳效率、进阶身体姿态、女性专项纠错和连续进攻策略分别保留直接来源。"
}
```
...
- 主证据候选: [快速架拍和力量架拍 在两者中间的架拍就是标准的普通架拍，既不会太慢，也不会没力，但是又都做不到极致的快和重，大家结合使用哦](https://www.douyin.com/video/7551459420703837498) (`7551459420703837498`)
- 主证据候选: [重杀框架 可以和期一起看，不同的框架可以决定不同的杀球](https://www.douyin.com/video/7659991105622862457) (`7659991105622862457`)
- 必看候选: [发力第一集 大家没看懂就在看一遍，做辅助训练的时候小臂一定要特别放松](https://www.douyin.com/video/7484563688096091449) (`7484563688096091449`)
...
- 必看候选: [重杀，遁地炮，跳杀连贯 很多年不见了，很怀念带她们训练的日子](https://www.douyin.com/video/7506362888166083897) (`7506362888166083897`)
- 必看候选: [花两分多钟把视频看完，让朋友们不在徘徊](https://www.douyin.com/video/7125615679402724623) (`7125615679402724623`)
- 必看候选: [遁地炮 14岁女孩，手无缚鸡之力的强力进攻，比较适合女生和业余球友，一定要确定手上动作正确的情况下增加这种跳法，不然容易大臂使用过多](https://www.douyin.com/video/7445495930280856892) (`7445495930280856892`)
...
```json
{
  ...
  "required_text_points": [
    {
      "description": "重杀使用力量型大框架；来球较高、时间充足时才适合扩大抬拍和顶肘空间，平快来球不能照搬重杀框架。",
      "acceptable_terms": [
        "力量型大框架",
        "来球较高",
        "不能照搬"
    ...
    {
      "description": "架拍时拍面保持立起，前臂不要藏到头后；肘朝后并让小臂位于大臂外侧，给手臂展开和向前顶肘留下空间。",
      "acceptable_terms": [
        "拍面保持立起",
        "前臂不要藏到头后",
        "小臂位于大臂外侧"
    ...
    {
      "description": "出拍由大臂和肘先向前带动放松的小臂，不是一开始就把前臂绷紧；可用小臂下垂练习寻找大臂先行的顺序。",
      "acceptable_terms": [
        "大臂先行",
        "小臂放松",
        "小臂下垂练习"
    ...
    {
      "description": "重杀依靠身体驱动大臂并在击球前加速，击球后及时放松随摆；不能让大臂脱离身体单独硬抡。",
      "acceptable_terms": [
        "身体驱动大臂",
        "击球前加速",
        "放松随摆"
    ...
    {
      "description": "全力重杀前段要保持放松，贴近击球区后再把力量集中打透；过早用力会让动作僵硬并丢失末段加速。",
      "acceptable_terms": [
        "前段保持放松",
        "力量集中",
        "过早用力"
    ...
    {
      "description": "重杀属于身体主导的大边甩，点杀则偏向手指主导的小边甩；两者不能共享同一套发力结论。",
      "acceptable_terms": [
        "身体主导",
        "大边甩",
        "手指主导的小边甩"
  ...
  "required_boundary_points": [
    {
      "description": "点杀、纯跳杀、霸王杀、反手杀球和遁地炮不能替代重杀专项；多变体来源只能引用其明确的重杀分段，且不能要求每一拍都全力重杀。",
      "acceptable_terms": [
        "不能替代重杀",
        "明确的重杀分段",
        "不能每一拍都全力"
  ...
  "notes": "把重杀从泛杀球、点杀、跳杀、霸王杀、反手杀球和遁地炮中拆出；保留直接讲力量框架、身体主导大边甩、放松贴球、顶肘空间和使用时机的来源。"
}
```
...
- 主证据候选: [A字霸王杀终于出来了，大家要灵活作用技术，不要唯一](https://www.douyin.com/video/7068465954270792994) (`7068465954270792994`)
- 必看候选: [看完这两集，再看我下集如何把它们合体，成为A字霸王杀，也会讲到收拍和半程旋转卸力的细节](https://www.douyin.com/video/7068092085533953315) (`7068092085533953315`)
- 主证据候选: [一定要3集看完再去练啊😂霸王杀就是尽可能的让动作最高效，爆发力最大化，出手快动作小，易衔接，重心摇摆小等特点，注意从引拍到击球为旋转发力，击球到动作结束为旋转卸力](https://www.douyin.com/video/7067722128413543680) (`7067722128413543680`)
...
```json
{
  ...
  "required_text_points": [
    {
      "description": "霸王杀追求在较小动作和较少重心摇摆下提高爆发与衔接效率，但仍需要正常引拍和鞭甩，不能理解成取消引拍。",
      "acceptable_terms": [
        "较小动作",
        "衔接效率",
        "不能取消引拍"
    ...
    {
      "description": "从引拍到击球采用转体带动的旋转发力，击球后再通过肘和手腕的旋转卸力；不能靠大幅摆动硬卸力。",
      "acceptable_terms": [
        "旋转发力",
        "旋转卸力",
        "不能靠大幅摆动"
    ...
    {
      "description": "A 字架拍和半程挥拍要求击球时回到正拍面，并通过击球后的旋转完成干净收拍；架拍立拍角度也不能无限后倒。",
      "acceptable_terms": [
        "A 字架拍",
        "半程挥拍",
        "正拍面"
    ...
    {
      "description": "辅助起跳时双臂先由下向上摆到高位，再完成架拍和击球；摆臂、架拍、击球要有先后，不能揉成一个连续上抬动作。",
      "acceptable_terms": [
        "双臂由下向上",
        "摆到高位",
        "不能揉成一个连续动作"
  ...
  "required_boundary_points": [
    {
      "description": "霸王杀是三集连续专项且属于高难度框架，必须结合完整系列和个人能力理解；来源也明确提醒技术要灵活使用，不是唯一正确的杀球方式。",
      "acceptable_terms": [
        "三集连续专项",
        "高难度框架",
        "不是唯一"
  ...
  "notes": "恢复三条连续的 A 字霸王杀专项来源；排除体系访谈、个人架拍比较、通用发力和网前撤后场中对霸王杀的顺带提及。"
}
```
...
- 必看候选: [8615 大家觉得这杀球教的怎么样？](https://www.douyin.com/video/7229506261136526647) (`7229506261136526647`)
- 主证据候选: [不同杀球 给大家解释为什么每个运动员动作不一样，其实在我的视角里，都是脚蹬地开始发力传递到球拍，但是每个人有差异，比如有的胳膊有劲儿，有的腰腹有劲儿，有的手腕有劲儿，通过漫长的训练，无意识的找到最适合自己发力配比，所以大家学习也得根据自己情况来](https://www.douyin.com/video/7567155406117533051) (`7567155406117533051`)
- 主证据候选: [发力第二集 大家不要错误的去伸胳膊，要学会利用身体去拿高点](https://www.douyin.com/video/7485692231404342586) (`7485692231404342586`)
- 必看候选: [技术简化的时代，要跟上技术发展的进程](https://www.douyin.com/video/7052519937125911846) (`7052519937125911846`)
- 主证据候选: [00:00 / 00:47 后场发力下集，由下到上一步一步带动全身协调发力，发力为外旋，不会伤手腕，伤手腕说明没外旋](https://www.douyin.com/video/7052600326116887812) (`7052600326116887812`)
- 必看候选: [杀球瞄准 杀球瞄准 卢迦彧的杀球不是那种很重的，所以落点上就尤为重要，比赛中非常容易被防守反击!中间涉及到了张指导的肖像权，已经经过了前辈本人的同意!](https://www.douyin.com/video/7659348110628345210) (`7659348110628345210`)
- 必看候选: [基础挥拍 可以当网课看了，@ 你不会挥拍的小伙伴来看吧](https://www.douyin.com/video/7453420876076240188) (`7453420876076240188`)
...
```json
{
  ...
  "required_text_points": [
    {
      "description": "普通杀球先建立共用的后场发力链条：架拍后由蹬地开始，依次通过腿髋、腰肩、肘和手指把力量传到球拍；动作应按来球位置简化，不追求固定的大幅度。",
      "acceptable_terms": [
        "蹬地",
        "腰肩",
        "力量传到球拍",
    ...
    {
      "description": "杀球的向下效果发生在挥拍后半段：先拿到高点击球，再让拍面在后半段向下；不能从动作一开始就只想着压腕或向下砸。",
      "acceptable_terms": [
        "高点",
        "挥拍后半段",
        "拍面向下"
    ...
    {
      "description": "不要把力量全部耗在扩大动作或把大臂整体甩出去；蹬地后先建立击球框架，再完成连贯挥拍。",
      "acceptable_terms": [
        "动作幅度",
        "大臂整体甩出",
        "击球框架"
    ...
    {
      "description": "杀球没有人人相同的唯一发力配比；脚到球拍的传递逻辑一致，但手臂、腰腹和手腕的参与比例应结合个人能力逐步形成。",
      "acceptable_terms": [
        "发力配比",
        "脚到球拍",
        "个人能力"
    ...
    {
      "description": "普通杀球不能只看力量，还要把球打得更尖、更靠边并保护下一拍；落点太长、太平会给对手平挡反击机会。",
      "acceptable_terms": [
        "更尖",
        "更靠边",
        "保护下一拍",
    ...
    {
      "description": "长篇基础挥拍来源用于核对握拍、架拍、转体、挥拍和腰腹加入的完整顺序，是普通杀球的共用基础，不是某个高级杀球变体的专项证明。",
      "acceptable_terms": [
        "基础挥拍",
        "握拍",
        "转体",
  ...
  "required_boundary_points": [
    {
      "description": "普通杀球、重杀、点杀、跳杀、劈杀、霸王杀和反手杀球是不同范围；其他变体来源不能替代普通杀球，反手视频中把普通杀球列为前提也不是普通杀球教学。",
      "acceptable_terms": [
        "不同范围",
        "不能替代普通杀球",
        "不是普通杀球教学"
  ...
  "notes": "把普通杀球从重杀、点杀、跳杀、劈杀、霸王杀和反手杀球中拆出；保留基础挥拍、发力链条、高点击球、动作幅度、个体体系、落点和衔接的直接来源。"
}
```
...
- 主证据候选: [并不是说一定要一步回位。而是体现向左回动，左脚的重要性](https://www.douyin.com/video/7059589039694957864) (`7059589039694957864`)
...
```json
{
  ...
  "required_text_points": [
    {
      "description": "现有来源直接覆盖的是正手位起跳不转身打对角线劈杀，并把它与同准备下的劈吊并列为可选手段。",
      "acceptable_terms": [
        "正手位",
        "起跳不转身",
        "对角线劈杀"
    ...
    {
      "description": "不转身的第一个目的，是减少明显的身体转动，让劈杀和劈吊的准备更隐蔽。",
      "acceptable_terms": [
        "不转身",
        "隐蔽",
        "身体转动"
    ...
    {
      "description": "更重要的目的在下一拍衔接：不转身可让左脚保持在前，击球后向左移动时能直接横跳；若单脚跳转导致左脚落到后面，还要多一步调整。",
      "acceptable_terms": [
        "左脚保持在前",
        "横跳",
        "下一拍衔接",
  ...
  "required_boundary_points": [
    {
      "description": "当前索引只有这一条直接劈杀来源，而且它主要讲不转身后的隐蔽、回动和衔接，没有足够证据说明劈杀的拍面、切削方向和触球细节；劈吊专项不能填补这部分空白。",
      "acceptable_terms": [
        "只有一条",
        "没有足够证据",
        "劈吊专项不能填补"
  ...
  "notes": "把劈杀从劈吊、普通杀球和其他杀球变体中拆出；现有唯一直接来源只支持正手位不转身劈杀的隐蔽与回动逻辑，不外推拍面和触球细节。"
}
```
...
- 主证据候选: [快速架拍和力量架拍 在两者中间的架拍就是标准的普通架拍，既不会太慢，也不会没力，但是又都做不到极致的快和重，大家结合使用哦](https://www.douyin.com/video/7551459420703837498) (`7551459420703837498`)
- 主证据候选: [这期很长 刘辉教练干货很多 建议大家多看几遍 会很有收获](https://www.douyin.com/video/7606412946096327978) (`7606412946096327978`)
- 必看候选: [体系认知 关注我的朋友，也是因为我讲的一个体系刚好在认知内，所以关注，如果我讲另一种情况，会不会就是不关注了？因为在认知外](https://www.douyin.com/video/7611635851789771721) (`7611635851789771721`)
- 必看候选: [重杀，遁地炮，跳杀连贯 很多年不见了，很怀念带她们训练的日子](https://www.douyin.com/video/7506362888166083897) (`7506362888166083897`)
...
```json
{
  ...
  "required_text_points": [
    {
      "description": "平快来球应采用较小的快速框架，减少侧身、抬肘和顶肘幅度以提高出手效率；来球较高且时间充足时才切换到力量型重杀框架。",
      "acceptable_terms": [
        "平快来球",
        "快速框架",
        "减少侧身",
    ...
    {
      "description": "快杀首先追求挥拍速度；顶肘后不要让大臂继续长距离前送，应让拍头尽快追上并超过大臂，并用快速抬拍缩短准备时间。",
      "acceptable_terms": [
        "挥拍速度",
        "大臂停止前送",
        "拍头追上",
    ...
    {
      "description": "快、重、准是有取舍的不同目标；快杀通常使用较小动作、高架拍和更少侧身来集中爆发，不能同时假定拥有重杀的大幅身体引动。",
      "acceptable_terms": [
        "快重准",
        "有取舍",
        "较小动作",
    ...
    {
      "description": "连续跳杀进攻时可先用较小侧身的快速跳杀保持连贯，出现终结机会再转为全力重杀；这条只适用于连续跳杀场景。",
      "acceptable_terms": [
        "连续跳杀",
        "保持连贯",
        "终结机会",
  ...
  "required_boundary_points": [
    {
      "description": "快杀、普通杀球、重杀、点杀、跳杀和霸王杀不能互相替代；比较来源只能使用其明确的快杀分段，连续跳杀来源不能扩展成通用快杀动作。",
      "acceptable_terms": [
        "不能互相替代",
        "快杀分段",
        "连续跳杀",
  ...
  "notes": "把快杀从普通杀球、重杀、点杀和跳杀中拆出；保留三条直接讲快速框架或挥速的来源，并把连续进攻中的快速跳杀限定在对应场景。"
}
```
...
- 主证据候选: [女双比赛里基本都是这样杀，击球的瞬间要比脚落地早一点，“基本”同时](https://www.douyin.com/video/7069575740836023587) (`7069575740836023587`)
...
```json
{
  ...
  "required_text_points": [
    {
      "description": "顿地炮基本不做正式起跳：重心先在后脚，经蹬地和短暂离地迅速移到左脚。",
      "acceptable_terms": [
        "基本不需要起跳",
        "后脚",
        "短暂离地",
    ...
    {
      "description": "要把身体从后向前和从上向下的力量同时卡到击球点，击球与落地接近同时发生。",
      "acceptable_terms": [
        "从后向前",
        "从上到下",
        "击球点",
    ...
    {
      "description": "它适合处在可跳杀位置但无法跳杀或暂不具备跳杀能力时使用，是跳杀能力不足时的补充而不是同一动作。",
      "acceptable_terms": [
        "可以跳杀的位置",
        "无法跳杀",
        "不具备跳杀能力",
    ...
    {
      "description": "击球后重心仍向前且没有明显摇摆，便于继续衔接；由于回球更可能偏平，要准备回抽或挡网跟进。",
      "acceptable_terms": [
        "重心向前",
        "没有重心摇摆",
        "平球",
  ...
  "required_boundary_points": [
    {
      "description": "遁地炮、顿地炮和蹲地炮是同一查询意图；标题写遁地炮但口播只讲原地重杀、只顺带提及想学蹲地炮或只列能力排名的来源，都不能证明专项动作。",
      "acceptable_terms": [
        "三种写法",
        "同一查询意图",
        "标题",
  ...
  "notes": "统一遁地炮、顿地炮和蹲地炮三种写法，只保留完整讲短暂离地、重心转移、击球落地时机和衔接的专项来源。"
}
```
...
```json
{
  ...
  "required_text_points": [
    {
      "description": "现有可引用分段只说明：和顿地炮相比，定杀至少缺少身体从上到下的力量。",
      "acceptable_terms": [
        "和顿地炮相比",
        "缺少",
        "从上到下的力"
  ...
  "required_boundary_points": [
    {
      "description": "当前知识库没有完整的定杀动作教学；同一视频只能支持差异比较，标题中的能力排名、原地重杀和其他杀球变体不能用来补写架拍、步法、触球或发力流程。",
      "acceptable_terms": [
        "没有完整",
        "只能支持差异",
        "不能补写",
  ...
  "forbidden_claims": [
    "现有来源完整讲解了定杀的所有动作",
    "定杀和顿地炮完全相同",
    "定杀必须采用某一种未经来源支持的手部发力"
  ],
  "notes": "把定杀识别为独立变体，但只允许当前唯一比较分段说明它与顿地炮的力量差异，不补写完整动作流程。"
}
```
...
- 主证据候选: [软压还包括点杀，远网吊球等等](https://www.douyin.com/video/7093706918492917033) (`7093706918492917033`)
...
```json
{
  ...
  "required_text_points": [
    {
      "description": "位置不好时不应勉强全力杀，可以用轻杀或软压先取得下压主动。",
      "acceptable_terms": [
        "位置不好",
        "不全力杀",
        "轻杀",
    ...
    {
      "description": "轻杀让球速稍慢但仍保持下压，避免球过去太快、回得也太快而导致脚下脱节。",
      "acceptable_terms": [
        "球速慢一点",
        "保持下压",
        "脚下脱节"
    ...
    {
      "description": "减速后的主要价值是给自己留下跟进时间，使下一拍更好衔接，再寻找强攻机会。",
      "acceptable_terms": [
        "跟进",
        "下一拍",
        "衔接",
  ...
  "required_boundary_points": [
    {
      "description": "当前轻杀来源只支持战术用途，不足以证明具体握拍、拍面、触球和手指发力；点杀、重杀或普通杀球动作来源不能填补这些细节。",
      "acceptable_terms": [
        "只支持战术",
        "不足以证明",
        "手部动作",
  ...
  "notes": "把轻杀从点杀和泛杀球中拆出；当前来源只可靠支持位置不好时减速保压、避免脚下脱节和连接下一拍的战术逻辑。"
}
```
...
- 类型：`technical_action`
- 预期模式：`balanced`
- 来源：`maintainer_backhand_smash_variant_audit`
- 当前状态：`maintainer_reviewed`
- 自动回归资格：已有

### 已有视频标签

- 主证据候选: [反手杀球 不同的击球位置也会使用不同的动作,都有不同的效果](https://www.douyin.com/video/7550305145877155131) (`7550305145877155131`)
- 主证据候选: [还有胳膊千万不能绷直，自然伸直就好](https://www.douyin.com/video/7202800263588105510) (`7202800263588105510`)
- 必看候选: [本视频适合进阶球友，可以收藏留着，师妹是我启蒙教练家的千金，全国大学生冠军](https://www.douyin.com/video/7288529711267859747) (`7288529711267859747`)
...
```json
{
  ...
  "required_text_points": [
    {
      "description": "反手体系会随击球位置变化：身前横向顶拍更接近抽高远，后场反手杀球要换成能向下出球的后场框架，不能把所有反手出球写成同一个动作。",
      "acceptable_terms": [
        "击球位置",
        "抽高远",
        "后场框架",
    ...
    {
      "description": "后场反手杀球可捏住拍柄两个窄边并让肘向上顶，使拍面能够把球向下打；这与身前横向外顶的框架不同。",
      "acceptable_terms": [
        "两个窄边",
        "肘向上顶",
        "向下",
    ...
    {
      "description": "顶肘后不要让大臂继续和小臂一起慢慢前送；大臂及时让出位置，让小臂和拍头更早超过大臂，可以加快挥速而不必削弱力量。",
      "acceptable_terms": [
        "顶肘后",
        "大臂让出位置",
        "小臂超过大臂",
    ...
    {
      "description": "背身处理普通反手杀球时，击球点应在右肩上方的高点；拇指应顶偏右侧小棱或捏窄边，而不是顶正宽面或偏左侧棱，以便拍面形成向下压制。",
      "acceptable_terms": [
        "右肩上方",
        "高点",
        "偏右侧小棱",
    ...
    {
      "description": "进阶来源在女性或业余球友腰腹参与受限的条件下，用击球前收肘靠近胸前带动拍头加速；来源明确要求已有反手基础，不能当作通用入门动作。",
      "acceptable_terms": [
        "进阶",
        "女性",
        "业余球友",
  ...
  "required_boundary_points": [
    {
      "description": "普通反手杀球、反手转圈杀和反手跳杀是不同变体，正手普通杀球与重杀来源也不能替代；多技术来源 720280... 只能使用其普通反手杀球分段。",
      "acceptable_terms": [
        "不同变体",
        "不能替代",
        "普通反手杀球分段",
  ...
  "notes": "把普通反手杀球从正手普通杀球、重杀、反手跳杀和反手转圈杀中拆出；保留两条基础专项和一条有明确进阶前提的来源。"
}
```
...
- 主证据候选: [最后有彩蛋，学习顺序，先得会反手的发力，和普通的鲨球，才能学这个](https://www.douyin.com/video/7098897570482670888) (`7098897570482670888`)
- 必看候选: [还有胳膊千万不能绷直，自然伸直就好](https://www.douyin.com/video/7202800263588105510) (`7202800263588105510`)
...
```json
{
  ...
  "required_text_points": [
    {
      "description": "转圈杀不是普通来球下故意转一圈；它用于来球很快、已经过身或到了身体左侧，正常转身后够不到、需要快速转体抢到球的场景。",
      "acceptable_terms": [
        "不是故意",
        "来球很快",
        "已经过身",
    ...
    {
      "description": "转圈来自快速转体后的惯性，击球后顺势继续旋转，而不是击球结束后再人为扭回去。",
      "acceptable_terms": [
        "快速转体",
        "惯性",
        "顺势",
    ...
    {
      "description": "发力时由腰带动上肢边甩，击球点比普通站立反手杀更靠后；找到球后左脚先蹬地，击球后右脚先落地。",
      "acceptable_terms": [
        "腰带动上肢",
        "击球点更靠后",
        "左脚蹬地",
    ...
    {
      "description": "另一条来源补充，转圈可能来自快速截击后的回动需要，也可能借身体旋转增加拍杆形变，使击球更短促、爆发更集中；只能使用该视频的转圈杀分段。",
      "acceptable_terms": [
        "快速截击",
        "回动需要",
        "拍杆形变",
  ...
  "required_boundary_points": [
    {
      "description": "反手转圈杀、普通反手杀球和反手跳杀不能互相替代；这是一种有明确来球和回动条件的特殊变体，不能作为所有反手杀球的默认动作。",
      "acceptable_terms": [
        "不能互相替代",
        "明确条件",
        "特殊变体",
  ...
  "notes": "把反手转圈杀识别为来球已过身或快速截击后的特殊反手杀球变体；排除普通反手杀球、反手跳杀和正手杀球来源。"
}
```
...
- 类型：`evidence_boundary`
- 预期模式：`balanced`
- 来源：`maintainer_missing_named_action_audit`
- 当前状态：`maintainer_reviewed`
- 自动回归资格：已有

### 已有视频标签

- 主证据候选: [花两分多钟把视频看完，让朋友们不在徘徊](https://www.douyin.com/video/7125615679402724623) (`7125615679402724623`)
- 主证据候选: [乱教3.0 学会通过架拍改善自己的顶肘，从而获得力量](https://www.douyin.com/video/7498295344284093755) (`7498295344284093755`)
...
```json
{
  ...
  "required_text_points": [
    {
      "description": "现有直接文字只支持平高球采用手指主导的小边甩发力，身体主要负责维持稳定；不能把身体主导的大边甩写成平高球的唯一默认发力。",
      "acceptable_terms": [
        "手指主导",
        "小边甩",
        "身体维持",
    ...
    {
      "description": "手指主导时可以从放松到捏紧完成发力；来源只讲发力模式，没有完整说明平高球的飞行线路、击球点和拍面流程。",
      "acceptable_terms": [
        "放松捏紧",
        "发力模式",
        "没有完整",
    ...
    {
      "description": "纯动作视频只可用于观察正手和反手后场平高球示范，不能从无口播画面推导具体手部机制或伪造时间戳。",
      "acceptable_terms": [
        "正手",
        "反手",
        "纯动作示范",
  ...
  "required_boundary_points": [
    {
      "description": "本方打平高球、处理对手平高球、用步法拦截平高球和比赛中顺带使用平高球是不同证据角色；后三类不能证明平高球击球动作。",
      "acceptable_terms": [
        "不同证据角色",
        "处理对手",
        "拦截",
  ...
  "forbidden_claims": [
    "处理对手平高球的视频可以证明本方怎么打平高球",
    "现有文字来源完整讲解了平高球的所有动作",
    "纯动作示范能够证明未经复核的拍面和手指细节"
  ],
  "notes": "当前知识库只有一条平高球发力分段和一条正反手纯动作示范；保留有限回答，排除接对方平高球、拦截平高球和比赛解说中的顺带提及。"
}
```
...
- 主证据候选: [安排，正反手一起](https://www.douyin.com/video/7151961376448138531) (`7151961376448138531`)
...
```json
{
  ...
  "required_text_points": [
    {
      "description": "假挑真放同时覆盖正手和反手，但必须区分真正向上挑球与最终切削放网，不能把两种触球写成同一动作。",
      "acceptable_terms": [
        "正手",
        "反手",
        "向上挑球",
    ...
    {
      "description": "真正做挑球时保持手腕锁住；反手拇指顶斜棱，并做轻微向上的动作以保持击球稳定。",
      "acceptable_terms": [
        "手腕锁住",
        "拇指斜棱",
        "向上",
    ...
    {
      "description": "切削放网阶段不要主动加入手指和手腕发力，应从头到尾锁住手腕并按来源所示方向削击；否则球容易飞起。",
      "acceptable_terms": [
        "手指手腕不要发力",
        "锁住",
        "削击",
  ...
  "required_boundary_points": [
    {
      "description": "715158... 只展示动作并明确说随后教学奉上，不能从该预告补写机制；普通挑球来源也不能单独证明假挑真放。",
      "acceptable_terms": [
        "只展示",
        "随后教学",
        "不能补写",
  ...
  "forbidden_claims": [
    "假挑真放需要主动甩腕加力",
    "纯展示预告完整讲解了假挑真放",
    "普通挑球动作可以直接证明假挑真放的切削细节"
  ],
  "notes": "将正反手假挑真放路由到直接教学分段，并把明确说后续再教学的纯展示预告设为硬负例。"
}
```
...
- 主证据候选: [后场框架应用 如果基础好，可以推荐出快速框架，之前发过很多爆发力出框架的作品！但是顶肘动作小带来效率的同时，也会因为顶肘动作小而削弱摆臂的幅度而失去力量！如果没有的专业力量的的朋友推荐第二种，但是要注意是拍低肘不低！不然会导致错误顶肘成为错误动作！ 总结，快速框架优点是容易做速度快效率高！缺点不好发力 动态低架优点是，容错率高，省力！缺点是不好学习 普通的架拍，优点是都能兼顾，缺点是该来不及的还是来不及](https://www.douyin.com/video/7589749293205363633) (`7589749293205363633`)
...
```json
{
  ...
  "required_text_points": [
    {
      "description": "问题来自球与球拍都从身体前方移动：球拍一边抬一边追，等拍头超过来球时已经失去合适发力位置。",
      "acceptable_terms": [
        "从前面",
        "一边追",
        "超过来球",
    ...
    {
      "description": "动态低架对应基础较弱者的方法二：不要从前面抬拍，先让球拍从下方向后绕到身体后方，再从该位置向前击球，把动作做完整。",
      "acceptable_terms": [
        "方法二",
        "不从前面抬",
        "从下方向后",
    ...
    {
      "description": "与快速框架的差别是：快速框架瞬间把球拍送到位以给挥拍留时间，但提前摆好框架不利于充分发力；两者按发力基础选择。",
      "acceptable_terms": [
        "快速框架",
        "瞬间到位",
        "留给挥拍",
  ...
  "required_boundary_points": [
    {
      "description": "这条来源只教后场准备路线和框架选择，不足以替代某个具体后场球种的完整击球、拍面和触球教学；升框架和泛动态发力也不是动态低架。",
      "acceptable_terms": [
        "只教准备",
        "框架选择",
        "不能替代完整击球",
  ...
  "notes": "将作者标题所称动态低架映射到同视频的方法二，只使用已复核的后场准备和绕拍分段，不混入升框架或泛动态发力。"
}
```
...
- 类型：`tactics`
- 预期模式：`balanced`
- 来源：`maintainer_ambiguous_term_audit`
- 当前状态：`maintainer_reviewed`
- 自动回归资格：已有

### 已有视频标签

- 主证据候选: [平搓远网 平搓可以根据情况加力减力，手臂也可以适当的介入辅助](https://www.douyin.com/video/7411850466457292084) (`7411850466457292084`)
- 主证据候选: [中路远网的博弈从民间一直到职业赛场，不要担心小孩听不懂，越不说越不懂](https://www.douyin.com/video/7262546080133401890) (`7262546080133401890`)
- 必看候选: [中路远网球用好了，场地会变小，做球和过渡的时候合理的使用有奇效](https://www.douyin.com/video/7076257912192060707) (`7076257912192060707`)
- 必看候选: [这种情况下是对方防守的好，过来的平，防远网转推的方法，如果有机会，还是越快抢点越高更好](https://www.douyin.com/video/7258462271670586658) (`7258462271670586658`)
...
```json
{
  ...
  "required_text_points": [
    {
      "description": "远网不是单一动作，至少要区分平搓远网、中路远网分球、防远网转推和远网吊球；泛问不能只给其中一种手法。",
      "acceptable_terms": [
        "不是单一动作",
        "平搓远网",
        "中路远网",
    ...
    {
      "description": "平搓远网用于来球较平、不能下压也不能近网搓的场景；正手以手腕类似拧灯泡控制拍面斜上和挥拍斜下，形成较平出球，反手再由手指随手腕介入加速。",
      "acceptable_terms": [
        "来球很平",
        "不能压",
        "拧灯泡",
    ...
    {
      "description": "中路远网面对对手中后场抓推时，不能盲目搓、挡或平推；先保持推球框架，再提肘、放低拍头完成正反手分球，并用拍面高度控制线路高低。",
      "acceptable_terms": [
        "中路",
        "不能盲目",
        "推球框架",
    ...
    {
      "description": "边线远网与中路远网的可用角度不同：边线可勾或平推，中路勾球和平推更容易出界，因此要用分球限制对手抓推。",
      "acceptable_terms": [
        "边线",
        "中路",
        "勾球",
    ...
    {
      "description": "防远网转推时，对方回球较平不要盲目多冲一步；应让出发力位，必要时由小臂和手指补发力，并用两侧喂球练习左右移动后再出球。",
      "acceptable_terms": [
        "不要多冲",
        "让出发力位",
        "小臂和手指",
  ...
  "required_boundary_points": [
    {
      "description": "各远网分支的来球条件、拍面和战术目标不同，不能把平搓手法、中路分球和防守转推拼成一个通用动作；杀上网后处理对手远网也应保留该前冲场景。",
      "acceptable_terms": [
        "分支",
        "条件不同",
        "不能拼成",
  ...
  "notes": "远网是深度与处理场景的统称，不是单一手法；泛问必须先说明歧义，再分平搓远网、中路远网分球和防远网转推。"
}
```
...
- 类型：`training_plan`
- 预期模式：`balanced`
- 来源：`maintainer_named_sequence_audit`
- 当前状态：`maintainer_reviewed`
- 自动回归资格：已有

### 已有视频标签

- 主证据候选: [今天偷懒，晚上见，发个没音乐的，纯粹目的杀上网就是交叉步，](https://www.douyin.com/video/7065157571816000809) (`7065157571816000809`)
- 主证据候选: [也不要问为什么不放网，对方远网球这个不可能去钓鱼失误率太高，也不能挡远网，惯性大没办法抓推](https://www.douyin.com/video/7092959332047785250) (`7092959332047785250`)
- 必看候选: [快@ 你们的女搭档来学习吧](https://www.douyin.com/video/7087759120761228578) (`7087759120761228578`)
- 必看候选: [软压还包括点杀，远网吊球等等](https://www.douyin.com/video/7093706918492917033) (`7093706918492917033`)
...
```json
{
  ...
  "required_text_points": [
    {
      "description": "只考虑杀球后继续向前衔接时，直接步法来源给出的核心是交叉步；这不是所有杀球后的通用回位。",
      "acceptable_terms": [
        "只考虑向前",
        "交叉步",
        "不是通用回位"
    ...
    {
      "description": "混双女选手从后场轮转向前时，可打斜线或中路杀上网后直接前走，把后场交给男队友；斜线和中路用于限制对手回球角度，必须保留搭档覆盖条件。",
      "acceptable_terms": [
        "混双",
        "女选手",
        "斜线",
    ...
    {
      "description": "杀上网到中路拿球时要按双方位置选择分边线路；由于身体带着从后向前惯性，推球若被抓容易立刻陷入防守反击。",
      "acceptable_terms": [
        "中路拿球",
        "分边",
        "从后向前惯性",
    ...
    {
      "description": "位置不好时可先用速度较慢的软压保持下压和脚下衔接，再逐步进入杀上网；它支持训练降速，不证明基础步法。",
      "acceptable_terms": [
        "位置不好",
        "软压",
        "慢一点",
    ...
    {
      "description": "默认 15 分钟练习应按热身、交叉步技术分解、固定线路或二选一衔接、自测组成，并给出三天修正、两周进阶和动作质量下降时停止的标准。",
      "acceptable_terms": [
        "15 分钟",
        "热身",
        "技术分解",
  ...
  "required_boundary_points": [
    {
      "description": "泛上网步法、泛杀球动作、原地重杀和比赛解说中的顺带提及不能证明杀上网；单双打覆盖不同，混双轮转规则不得推广为单打默认。",
      "acceptable_terms": [
        "泛上网不能证明",
        "泛杀球不能证明",
        "单双打不同",
  ...
  "notes": "将杀上网识别为杀球后的特定向前衔接，不再退化成泛上网或泛杀球；保留核心交叉步、混双轮转条件、中路线路和软压进阶。"
}
```

## AQ055 · 来不及接网前小球或者网前吊球怎么办

- 类型：`diagnosis`
- 预期模式：`balanced`
- 来源：`maintainer_forecourt_reception_symptom_feedback`
- 当前状态：`maintainer_reviewed`
- 自动回归资格：已有

### 已有视频标签

- 主证据候选: [终于有时间再更新步法了](https://www.douyin.com/video/7353467942706695458) (`7353467942706695458`)
- 主证据候选: [正手网前步法 当然还要注意左手的摆放和重心的控制，但是时间有限，直播的时候讲吧](https://www.douyin.com/video/7406541084219821312) (`7406541084219821312`)
- 必看候选: [职业运动员上网因为身体能力强，大部分采用跨步，但是依然每局还是能见到垫步的出现](https://www.douyin.com/video/7099644893269839144) (`7099644893269839144`)
- 必看候选: [跑动节奏 步法到早到晚都会让动作的节奏脱节，这个是可以加入主观意识去匹配速度的](https://www.douyin.com/video/7642648621985030138) (`7642648621985030138`)
...
```json
{
  ...
  "required_text_points": [
    {
      "description": "先把问题解释为到达前场的向前启动和上网步法，而不是用户自己要打吊球或网前小球。",
      "acceptable_terms": [
        "向前启动",
        "上网步法",
        "来球条件",
    ...
    {
      "description": "正手前场启动时先打开腿部支撑，让左腿到左后方形成向右前方蹬出的空间，再完成第一步。",
      "acceptable_terms": [
        "先开腿",
        "左腿",
        "左后方",
    ...
    {
      "description": "按距离选择步法：距离近可用高频并步，距离长则组合并步、垫步和蹬跨步，最后一步落稳且膝盖脚尖外摆。",
      "acceptable_terms": [
        "距离近",
        "并步",
        "垫步",
    ...
    {
      "description": "长距离上网不要全程碎步；途中加入垫步可少走一步并降低前冲惯性。",
      "acceptable_terms": [
        "不要碎步",
        "垫步",
        "少一步",
    ...
    {
      "description": "跑动不是从头到尾只求快：第一启动可以快，追球过程要匹配球速，最后确认步保留调整。",
      "acceptable_terms": [
        "第一启动",
        "匹配球速",
        "最后确认步",
  ...
  "required_boundary_points": [
    {
      "description": "现有直接来源主要覆盖正手前场和不同距离的向前移动；杀球后的杀上网是另一种特定衔接，反手被动高远也不能证明本题。",
      "acceptable_terms": [
        "正手前场",
        "不同距离",
        "杀上网是另一种",
  ...
  "notes": "将来不及接前场来球解释为向前启动和上网步法问题；来球名称只作为条件，排除仅命中来不及的反手被动高远及杀上网专项。"
}
```
...
- 类型：`diagnosis`
- 预期模式：`balanced`
- 来源：`maintainer_kill_to_net_symptom_feedback`
- 当前状态：`maintainer_reviewed`
- 自动回归资格：已有
...
```json
{
  ...
  "required_text_points": [
    {
      "description": "把问题识别为杀上网专项中的到位症状；它与杀球后应该怎样上网共享目标动作和核心证据，但需额外诊断为什么跟不上。",
      "acceptable_terms": [
        "杀上网专项",
        "到位症状",
        "核心动作相同",
    ...
    {
      "description": "只考虑杀后继续向前时，直接步法来源给出的核心是交叉步；先检查落地后第一步是否立即且平衡地向前。",
      "acceptable_terms": [
        "交叉步",
        "落地后第一步",
        "向前",
    ...
    {
      "description": "位置不好时勉强全力杀会让回球过快并造成脚下脱节；可先用慢一些的软压保持下压并为跟进留时间。",
      "acceptable_terms": [
        "位置不好",
        "全力杀",
        "脚下脱节",
    ...
    {
      "description": "杀上网有从后向前惯性，到中路后仍要按双方位置分边，并保留停止前冲或转守的能力，不能机械冲网。",
      "acceptable_terms": [
        "从后向前惯性",
        "中路",
        "分边",
    ...
    {
      "description": "混双女选手从后场杀上网可由男队友覆盖后场；该轮转条件不能推广为单打或无搭档覆盖的默认做法。",
      "acceptable_terms": [
        "混双",
        "男队友覆盖",
        "不能推广",
  ...
  "required_boundary_points": [
    {
      "description": "泛化的来不及、反手被动高远、动态低架、泛上网和泛杀球不能证明本题；症状词不得压过杀球到上网的完整动作序列。",
      "acceptable_terms": [
        "反手被动高远不能证明",
        "动态低架不能证明",
        "完整动作序列",
  ...
  "notes": "把来不及上网保留为杀上网专项中的到位症状；核心动作与教学问法一致，额外诊断重杀过度、脚下脱节和停止前冲的条件。"
}
```

## AQ057 · 杀球后被对手挡网，我总是来不及上去怎么办

- 类型：`diagnosis`
- 预期模式：`balanced`
- 来源：`maintainer_kill_to_net_opponent_response_feedback`
- 当前状态：`maintainer_reviewed`
- 自动回归资格：已有
...
```json
{
  "maintainer_decision": "approved",
  "maintainer_reviewer": "Codex evidence review",
  "maintainer_reviewed_at": "2026-07-21",
  "primary_video_ids": [
    "7065157571816000809",
    "7092959332047785250"
  ],
  ...
  "required_text_points": [
    {
      "description": "明确恢复球员杀球、对手挡网、球员继续上网的三段事件链，并把问题识别为杀上网到位症状。",
      "acceptable_terms": [
        "杀上网",
        "对手挡网",
        "继续上网",
    ...
    {
      "description": "决定杀上网后，向前衔接要从杀球落地后的第一步开始；直接步法来源给出的核心是交叉步。",
      "acceptable_terms": [
        "落地后第一步",
        "交叉步",
        "向前衔接"
    ...
    {
      "description": "位置不好时勉强全力杀会让回球过快并造成脚下脱节，可用慢一些的软压保持下压并争取跟进时间。",
      "acceptable_terms": [
        "位置不好",
        "全力杀",
        "脚下脱节",
    ...
    {
      "description": "杀上网带有从后向前惯性，到中路后应按双方位置选择线路，并保留停止前冲或转守的能力。",
      "acceptable_terms": [
        "从后向前惯性",
        "中路",
        "双方位置",
    ...
    {
      "description": "混双女选手后场杀上网必须保留男队友覆盖后场的条件，不得推广成所有单双打的固定轮转。",
      "acceptable_terms": [
        "混双",
        "男队友覆盖",
        "不能推广",
  ...
  "required_boundary_points": [
    {
      "description": "反手被动高远、动态低架、泛杀球和泛上网不能替代杀上网事件链的直接证据。",
      "acceptable_terms": [
        "反手被动高远不能证明",
        "动态低架不能证明",
        "泛杀球",
  ...
  "forbidden_claims": [
    "杀球后被挡网来不及上去应该练反手被动高远",
    "看到对手挡网以后才开始向前移动",
    "所有杀球后都必须立即冲到网前"
  ],
  "notes": "把球员杀球、对手挡网和球员来不及上去保留为跨主体杀上网事件链；不因对手响应插入或上去这一省略表达退化为泛杀球与泛来不及检索。"
}
```
